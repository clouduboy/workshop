...
! gfx_defender 9x9@#ffffff,#ff77a8,#454545,#83769c,#29adff
.........
.........
.........
....#....
...
! rocket 3x4@#c2c3c7,#ffffff,#ff004d
.#.
#2#
#2#
.3.
...
const gfxIntro = game.loadSprite(`
  ...
  ................................................................................................
  ................................................................................................
  ......333333....3333.............................333............3333............................
  .....3......3...3..3............................3..3............3..3............................
  ....3...33...3..3..3............................3..3............3..3............................
  ...3...3..3...3.3..3...33333....333...333...33333..3..333...33..3..33333.....33333...333....33..
  ...3..3....3..3.3..3..3.....3..3..3..3..3..3....3..3.3..3..3..3.3..3....3...3.....33.3..3..3..3.
  ...3..3.....333.3..3.3...3...3.3..3..3..3.3........3.3..3..3..3.3....3...3.3.......333..3..3..3.
  ...3..3.........3..3.3..3.3...33..3..3..3.3..3333..3.3..3..3..3.3...3.3..3.3..3333..33..3.3..3..
  ...3..3.....333.3..33..3...3..33..3..3..3.3..3..3..3.3..3..3..3.3..3..3..3.3..3..3..3.3..33..3..
  ...3..3....3..3.3..33..3...3..33..3..3..3.3..3..3..3.3..3..3..3.3..3..3..3.3..3..3..3.3..33..3..
  ...3..3....3..3.3..33..3...3..33..3..3..3.3..3..3..3.3..3..3..3.3..3..3..3.3..3..3..3.3..3..3...
  ...3...3333...3.3..3.3..3.3...33...333..3.3..3333..3.3...333..3.3...333..3.3..3333..3..3....3...
  ....3........3..3..3.3...3...3.3........3.3........3.3........3.3........3.3.......3...3...3....
  .....3......3...3..3..3.....3...3....3..3..3....33.3..3....3..3.3..3....3...33....33....3..3....
  ......333333....3333...33333.....3333.333...3333.333...3333.333..33.3333.....33333.....3...3....
  ....................................................................................3333..3.....
  ....................................................................................3.....3.....
  .....................................................................................33333......
`);
...
// How long does the intro screen show (in seconds)
const INTRO_SCREEN_DELAY = 2;
...
game.loop(function() {
  ...
  if (intro) {
    if (game.frameCount - introAfter < INTRO_SCREEN_DELAY*game.frameRate) {
      // Draw intro screen
...
function defeat() {
  ...
  if (defeat_after>0 && game.frameCount-defeat_after>3*game.frameRate) {
    game.fillStyle = "white";
    game.centerText("press ENTER (A)", game.width/2, game.height-8*2);
    game.centerText("to try again", game.width/2, game.height-8);
...
function victory() {
  ...
  game.centerText("EARTH IS SAVED!", game.width/2, game.height/2);
  ...
  game.drawImage(gfxInvader[2], game.width/2+36, game.height/2-9);

  if (victory_after == 0) victory_after = game.frameCount;
  if (victory_after > 0 && (game.frameCount - victory_after) > 2*game.frameRate) {
	const fall = (game.frameCount - victory_after - 2*game.frameRate)*2 + game.height/2+2;

    if (fall < game.height) {
	    game.drawImage(gfxInvader[2], game.width/2-40, fall);
    } else {
      game.fillStyle = "white";
      game.centerText("press ENTER (A)", game.width/2, game.height-8*2);
      game.centerText("to play again", game.width/2, game.height-8);
	...
	game.drawImage(gfxInvader[2], game.width/2-40, game.height/2+2);
  }
